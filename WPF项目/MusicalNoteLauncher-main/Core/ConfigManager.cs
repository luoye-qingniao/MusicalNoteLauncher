    ...
    public class ConfigManager
    {
        ...
        public void EnsureGameDirectoryExists()
        {
            try
            {
                ...
                string[] subFolders = { "versions", "assets", "assets\\indexes", "libraries", "saves", "mods", "resourcepacks", "shaderpacks", "screenshots", "crash-reports", "server-resource-packs", "logs", "java", "runtime", "config", "launcher-logs" };
