...
namespace PCL.Account
{
    ...
    public static class AccountManager
    {
        ...
        public static string GetQingNiaoServer()
        {
            return McInstanceSelected != null
                ? Settings.Get<string>("VersionServerQingNiao", McInstanceSelected)
                : Settings.Get<string>("CacheQingNiaoServer");
        }

        public static McLoginServer GetQingNiaoLoginData(string userName = null, string password = null)
        {
            string server = GetQingNiaoServer();
            return new McLoginServer
            {
                Token = "QingNiao",
                BaseUrl = $"https://{server}/authserver",
                UserName = userName ?? Settings.Get<string>("CacheQingNiaoUsername"),
                Password = password ?? Settings.Get<string>("CacheQingNiaoPass"),
                Description = "青鸟账号",
                Type = McLoginType.Auth
            };
        }

        public static void ClearQingNiaoAccessOnInputChange()
        {
            Settings.Set("CacheQingNiaoAccess", "");
        }

        public static void ClearQingNiaoProfileCache()
        {
            Settings.Set("CacheQingNiaoUuid", "");
            Settings.Set("CacheQingNiaoName", "");
        }

        public static void ExitQingNiaoLogin()
        {
            Settings.Set("CacheQingNiaoAccess", "");
            Settings.Set("CacheQingNiaoUuid", "");
            Settings.Set("CacheQingNiaoName", "");
