...
{
    public class FileDownloadTaskViewModel : IDownloadTask
    {
        ...
        public FileDownloadTaskViewModel(string downloadUrl, string savePath)
        {
            _downloadUrl = downloadUrl;
            _savePath = savePath;
            _versionId = Path.GetFileName(savePath);
            _status = "等待中";
            _progress = 0;
            _downloadedBytes = 0;
            _totalBytes = 0;
            _currentFile = _versionId;
            _downloadSpeed = "--";
            _remainingTime = "--";
            _isPaused = false;
        }
